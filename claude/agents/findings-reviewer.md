...
Read coding-standards in Read expectations mode and include its standards assessment in the report. Use the source and target exceptions supplied in the assignment, or the installed skill when no source is supplied. Do not run enforcement adoption.
