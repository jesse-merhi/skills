...
- **Explanation:** `html-explanations` turns decisions, code flows, incidents,
  ...
  question.
- **Project-specific skills:** `skills/openclaw/` and `skills/agent-aquarium/`
  contain product-specific workflows. They are grouped so the public repo stays
  legible, but they still install by skill name.
