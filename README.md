...
| Skill | What it does |
| --- | --- |
| [`writing-good-tests`](skills/writing-good-tests/SKILL.md) | Implements behavior, tests valid inputs and failure cases, and cleans up weak tests along the way; review-only work stays read-only. |
