...
| [`feedback-hardening`](skills/feedback-hardening/SKILL.md) | Turns corrections of agent behavior into an independent systemic-fix recommendation, waits for Jesse's approval, then implements the selected repair. |
