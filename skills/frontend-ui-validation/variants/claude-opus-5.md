...
Validate the requested states and viewport matrix without inventing speculative states, persistent test suites, or verifier agents. Report concrete failures and the required evidence; preserve the affected-state rerun after a repair.
