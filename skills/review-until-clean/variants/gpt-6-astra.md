...
Continue the selected authorized loop without repeat approval questions. The required two clean native passes are completion criteria, not optional extra testing; keep the exact bare-engine and same-tree rules.
