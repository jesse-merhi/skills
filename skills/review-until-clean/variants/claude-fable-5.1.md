...
Finish the native review loop through its clean stop condition. Batch
independent reads and checks around each review result. During long reviews or
waits, report a fresh result, accepted fix, validation change, or blocker. Keep
fixes and tests limited to accepted findings and use targeted edits.
