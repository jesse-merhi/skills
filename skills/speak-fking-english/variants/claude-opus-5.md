...
Control the length of saved artifacts as well as chat. Run the selected editing sequence once, keeping all material evidence and caveats; do not add repeated self-review loops or narrated self-correction.
