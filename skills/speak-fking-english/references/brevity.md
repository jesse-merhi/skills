...
4. Protect what matters.
   ...
   compatibility warnings, and the user's requested detail.

Read the result once more. Done when every remaining sentence changes what the
reader understands or does, and deleting another sentence would make the answer
