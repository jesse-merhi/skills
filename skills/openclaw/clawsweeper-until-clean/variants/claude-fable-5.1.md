...
Finish the authorized ClawSweeper loop through its clean stop condition. Batch
independent PR and review-state checks. During waits and fixes, report a fresh
review, changed evidence, completed validation, or blocker. Make targeted fixes
only for accepted findings; do not add unrelated tests or rewrites.
