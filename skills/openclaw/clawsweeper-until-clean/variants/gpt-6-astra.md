...
Once applicability and authority are established, run the prescribed loop without asking on each iteration. Preserve all clean-pass, rank-up, comment-authority, and recovered-attempt limits.
