...
Finish the authorized local setup and prove the browser flow is ready for the
user. Batch independent environment and configuration checks. Report meaningful
changes during long install or startup work. Verify unfamiliar version-specific
behavior from installed sources. Prefer targeted configuration edits and avoid
