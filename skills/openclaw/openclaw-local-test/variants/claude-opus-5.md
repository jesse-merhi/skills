...
Use the owned helper and a compact startup report. Do not expand setup into a general Gateway audit or add a verifier team; retain the distinct Gateway, proxy, and wizard lifecycle checks.
