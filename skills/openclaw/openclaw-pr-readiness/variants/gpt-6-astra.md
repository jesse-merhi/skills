...
Resolve applicability and existing publication authority first, then complete the authorized gate work. Use named workflows only when their contracts apply; do not infer a new arbitrary subagent grant.
