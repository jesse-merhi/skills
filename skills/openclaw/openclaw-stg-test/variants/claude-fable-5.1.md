...
Finish the authorized preview and prove that the reviewer can use it safely.
Batch independent build, tunnel, and browser checks. Report meaningful changes
during long publish or validation work. Verify current tool behavior from
installed sources. Keep edits and exposed resources limited to this temporary
preview.
