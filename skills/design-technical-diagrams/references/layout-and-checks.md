...
Inspect the whole picture, text at destination size, and magnified details. Check crop, padding, fonts, arrows, symbols, loop direction, and export readability. A high-resolution image cannot rescue text made too small by layout.
