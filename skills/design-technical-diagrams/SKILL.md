...
3. **Magnified detail:** inspect around 2× for clipping, collisions, uneven
   padding, collapsed bottom insets, content escaping its card, broken icons,
   malformed or hollow arrowheads, arrowheads that consume the route, marker
   nubs, doubled lines, and off-by-a-few-pixels alignment.
