...
Outcome: make one system relationship easier to understand as a picture. Inspect the
...
Keep the diagram and its handoff concise. The required sketches, rendered inspection, and export checks prove the deliverable; do not add a generic verification round or an optional diagram-verifier agent.
