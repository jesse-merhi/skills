...
Infer the reader and destination from the supplied context when practical. Choose among the required sketches locally; ask only when the unresolved choice changes the explanation or scope.
