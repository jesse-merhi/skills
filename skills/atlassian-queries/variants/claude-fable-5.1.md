...
Use the direct Atlassian MCP tools and name the intended site on every request. Discover the supported operation when needed, then call the relevant search or read tool. If direct tools are unavailable, report what is missing.
