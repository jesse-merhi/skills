...
Choose the smallest useful page from the reader’s question and begin. Do not ask the user to select a routine template or inflate the page with dashboards; keep all required rendering checks.
