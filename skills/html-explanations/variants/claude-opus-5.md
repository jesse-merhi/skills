...
Control the saved page as well as the chat reply: one answer, only useful interactions, and no repeated summary cards or empty report sections. Required rendering, accessibility, and print checks remain part of the deliverable.
