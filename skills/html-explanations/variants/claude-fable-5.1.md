...
Complete the requested page and inspect the rendered result. Batch independent
source reads and visual checks. During long generation or browser work, report
new evidence, a changed direction, or a blocker. Use literal copy, short
sentences, and useful structure. Keep edits and assets limited to the requested
page.
