...
Use the explicit invocation to resolve the permitted read or write mode and start the full session. Ask again only if a material scope decision remains unresolved.
