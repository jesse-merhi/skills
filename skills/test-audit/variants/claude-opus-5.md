...
Keep the report concise without filtering discovery by severity or a top-N limit. Classify all genuine missing, duplicate, and unsafe-ownership candidates, then report populated buckets and the required cost conclusion. Do not invent tests to demonstrate diligence.
