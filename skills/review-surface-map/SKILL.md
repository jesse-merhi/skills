...
2. Classify changed files by behavior surface using
...
- Do not call something a bug until the relevant surface has been traced enough
...
- Use [target-resolution.md](references/target-resolution.md) for PR and git
  range commands.
- Use [surfaces.md](references/surfaces.md) for changed-file classification.
