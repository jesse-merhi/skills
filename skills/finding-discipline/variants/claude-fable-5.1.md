...
Assess the complete candidate set against current evidence. Batch independent
contract and reachability checks. For a long review, report only a change in
evidence or direction. Return concrete actionable findings and discard nits,
duplicates, and unsupported risks. Do not edit the target.
