...
Outcome: return fewer, sharper findings that a PR author can act on. Start only
after inspection establishes a concrete runtime failure or present maintenance
cost.
