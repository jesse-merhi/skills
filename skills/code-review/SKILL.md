...
1. Phase 1: run `review-until-clean` until the tool-native review is clean.
...
Phase 1 uses the tool-native review engine: bare `codex review` in Codex,
...
2. Select the review engine.
   ...
   Use the tool-native engine unless the user explicitly names another:
   ...
   Use the model configured by the selected agent tool. Do not hard-code or
...
- The selected tool-native review engine started successfully with its
  configured model.
