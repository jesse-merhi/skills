...
Continue through the selected phases and authorized fixes without reopening the settled engine or review decision. Dispatch the independent workers required by the workflow when their triggers apply; keep its real consult and scope stops.
