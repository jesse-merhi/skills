...
`, { mode: 0o700 })
      ...
      try {
        ...
        assert.include(stdout, `review: ${join(bin, "codex")} ${profile ? "--profile findings-reviewer " : ""}review -c model="gpt-6-astra" -c review_model="gpt-6-astra" -c model_reasoning_effort="high" --base master`)
      } catch {
        failed = true
      }
      ...
      assert.deepStrictEqual(recorded, [[
        ...
        "-c", 'model_reasoning_effort="high"', "--base", "master"
      ]])
      if (reviewFails) {
