...
export const readReviewLimits = Effect.fn("ReviewLimits.read")(function*(runId: string, head = "", phase?: ReviewPhase) {
  ...
  return {
    ...
    nextAction: stoppingReasons.some(reason => ["CONSULT_CAP_REACHED", "QUEUE_FIXED_POINT", "NEW_BINARY_PATHS", "SCOPE_REBASELINE_REQUIRED", "REPAIR_CONSULT_REQUIRED"].includes(reason)) ? "consult"
