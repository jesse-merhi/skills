  ...
  return yield* sql.withTransaction(Effect.gen(function*() {
    ...
    if (repairEvent) {
      ...
      if (event.outcome === "repair-replanned") {
        ...
        if (event.diagnosis !== undefined || event.changedApproach !== undefined) return yield* new ProgressConflict({ message: "Repair attempts cannot carry a diagnosis or changed approach" })
