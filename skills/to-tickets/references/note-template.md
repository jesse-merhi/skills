...
<Known constraints, relevant code, prerequisites, and any order that actually matters. Record an unresolved user decision here; do not turn it into an assigned status.>
