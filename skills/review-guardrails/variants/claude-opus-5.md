...
Record and triage all genuine candidates without treating them as automatic fixes. Keep scope and consultation messages short and concrete; add no ad hoc iteration limits or extra rounds beyond the configured fixed point.
