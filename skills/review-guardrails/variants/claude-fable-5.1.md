...
Apply the bounds to the complete authorized review loop. Batch independent
scope, budget, registry, and coverage checks. Report a changed budget, scope
decision, consult state, or blocker during long work. Keep every fix inside the
recorded authority and stop exactly at the configured limit.
