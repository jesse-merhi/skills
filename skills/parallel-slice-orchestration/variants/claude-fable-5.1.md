...
Finish the full authorized slice plan through integration and verification.
Batch independent preparation and dispatch independent workers together. Keep
the lead working while workers run when useful. Report completed slices,
changed dependencies, integration evidence, and blockers. Keep each worker and
edit inside its assigned scope.
