...
Complete the requested local checkout and review-view setup. Batch independent
PR, worktree, and editor checks. During long setup, report a changed state or
blocker. Verify current CLI behavior from installed help or source. Keep all
changes inside the dedicated review worktree and the named PR.
