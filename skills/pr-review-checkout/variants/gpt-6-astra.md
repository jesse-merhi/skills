...
Resolve the requested PR and worktree from Git and the existing helper, then open the review flow. Keep orientation to the observable before-and-after behavior rather than a file inventory.
