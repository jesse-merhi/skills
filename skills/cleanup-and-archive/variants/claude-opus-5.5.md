...
Use the current session unless the user names another. Creating or editing this skill does not invoke it. Invocation authorizes [cleanup](../cleanup/SKILL.md) and archiving the selected session, not unrelated maintenance. Ask only for decisions cleanup reserves for the user.
