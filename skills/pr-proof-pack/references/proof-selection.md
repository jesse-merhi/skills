...
The visual explains the behavior. The screenshot or recording demonstrates the
implementation running. Most non-trivial PRs need both. Do not use a screenshot
of the explanation visual as the only proof that the behavior ran.
