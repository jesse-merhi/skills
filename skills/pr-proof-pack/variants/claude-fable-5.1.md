...
Read the PR and diff using the [GitHub](references/github.md) or [Bitbucket](references/bitbucket.md) guide. Compare its description and proof with the change; leave accurate material alone.
