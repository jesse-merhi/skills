...
Complete the proof check or authorized refresh against the exact current head.
Batch independent PR, diff, and artifact reads. During long capture or upload
work, report new evidence, a changed proof plan, or blocker. Preserve quoted
source text exactly and label it as quotation. Keep PR edits and assets limited
to the claims the change requires.
