...
Use the single required recommendation-only worker. Keep its brief and proposed remedy compact; no nested recommendation team or extra verifier replaces the authenticated completion and approval gates.
