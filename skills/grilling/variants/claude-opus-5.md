...
Settle every branch of the user's decision tree through question rounds, then obtain confirmation of shared understanding. The deliverable is the settled understanding, not implementation of it.
