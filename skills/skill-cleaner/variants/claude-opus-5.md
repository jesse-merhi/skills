...
Keep the analyzer-led report to useful inventory and cleanup decisions. Do not turn an audit into deletion, installation changes, a prompt rewrite, or a verification-agent fan-out without the existing required authority.
