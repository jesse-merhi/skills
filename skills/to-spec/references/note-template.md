...
- PR gates: before readiness or merge, apply the Review gate and Sign-off gate from `AGENTS.md` to each PR. The Review gate must cover the exact head; Sign-off persists for the PR across later heads.
