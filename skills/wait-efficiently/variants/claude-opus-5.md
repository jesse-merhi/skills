...
Use the existing event-driven hold and meaningful-only reporting. Do not add progress narration, a polling helper, or a separate worker whose only job is to wait.
