...
Use short, concrete replacement advice and familiar terms. Investigate an ordinary type or ownership question from code before asking the user; preserve the read-only boundary of a review.
