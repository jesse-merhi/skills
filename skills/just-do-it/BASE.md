...
Delegate useful independent questions to the configured investigator and owned changes with focused tests to the implementer. Supply the objective, worktree and revision, scope, constraints, acceptance criteria and relevant evidence. Keep reusable instructions and settings in the role definitions, and sequencing, integration, shared verification and delivery with the coordinator. Do not launch a fixed agent tree. Route independent review through `code-review`.
