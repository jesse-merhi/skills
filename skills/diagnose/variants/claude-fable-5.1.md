...
Batch independent reads and checks. During a long investigation, report only
meaningful changes in evidence or direction.
...
- Search current sources for unfamiliar or version-sensitive behavior.
...
- Keep extra scope, tests, and whole-file rewrites inside the authorized fix.
