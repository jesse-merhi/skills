...
Choose an existing narrow boundary from the requested behavior and repository evidence. Preserve the material seam-decision checkpoint, but do not ask the user to settle routine test mechanics.
