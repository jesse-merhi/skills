...
Keep grounding notes and question rounds compact. Group related fact probes, and do not widen the task into rewriting project documentation or spinning up one worker per lookup.
