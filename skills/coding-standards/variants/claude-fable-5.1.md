...
Batch independent inspections and give brief updates for lengthy work. Mark source quotations distinctly from summaries. Verify active checks and wiring per the chosen mode's reference. Ground unfamiliar tooling in installed source or current primary documentation; do not expand into unrelated audits or a lint framework.
