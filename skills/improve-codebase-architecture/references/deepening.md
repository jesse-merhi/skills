...
How to deepen a cluster of shallow modules safely. Assumes the shared
vocabulary: **module**, **interface**, **seam**, and **adapter**.
...
- Do not introduce a port unless at least two adapters are justified, usually
  production and test.
- A deep module can have internal seams used by its own implementation and
...
- Old tests on shallow modules can be deleted once the deeper interface tests
  cover the behavior.
