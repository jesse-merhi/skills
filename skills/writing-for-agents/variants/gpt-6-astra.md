...
Read the relevant skills, AGENTS.md, CLAUDE.md, and linked documents together. Resolve routine choices from these sources and contradictions at their owner; preserve decisions that require the user.
