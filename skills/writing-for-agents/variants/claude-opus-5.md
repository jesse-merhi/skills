...
Distinguish invariant completion gates from redundant generic self-check scaffolding. Keep written artifacts proportionate and each rule authoritative once; required evidence and permissions must remain equivalent across model variants.
