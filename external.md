...
- **Pinned revision:** `47727ffc7590e1c19c9e02b6574dc6c5f96cf1be` from [draft PR #1](https://github.com/jesse-merhi/repo-queue/pull/1). This pins the TypeScript package and complete skill variants. Update it deliberately after validation; do not track a moving branch.
...
```sh
queue_revision=47727ffc7590e1c19c9e02b6574dc6c5f96cf1be
