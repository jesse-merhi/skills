...
- **Pinned revision:** `e50c65a9035c278eb121421edf6f5eeecd5804d0` from [draft PR #1](https://github.com/jesse-merhi/repo-queue/pull/1). This pins the TypeScript package and complete skill variants. Update it deliberately after validation; do not track a moving branch.
...
```sh
queue_revision=e50c65a9035c278eb121421edf6f5eeecd5804d0
