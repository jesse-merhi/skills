...
- **Pinned revision:** `144d192b055fdf6710c61653d10e632d6fb29ffd` from [draft PR #1](https://github.com/jesse-merhi/repo-queue/pull/1). This pins the TypeScript package and complete skill variants. Update it deliberately after validation; do not track a moving branch.
...
```sh
queue_revision=144d192b055fdf6710c61653d10e632d6fb29ffd
