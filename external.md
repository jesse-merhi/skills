...
- **Pinned revision:** `73f2de9a3aeaf5b19d71df4c6fa6589c9cf72ae6` from [draft PR #1](https://github.com/jesse-merhi/repo-queue/pull/1). This pins the TypeScript package and complete skill variants. Update it deliberately after validation; do not track a moving branch.
...
```sh
queue_revision=73f2de9a3aeaf5b19d71df4c6fa6589c9cf72ae6
