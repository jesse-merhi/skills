...
- **Pinned revision:** `dfcb59ccaea17d68fbd187f3ab19448e1feef894` from [draft PR #1](https://github.com/jesse-merhi/repo-queue/pull/1). This pins the TypeScript package and complete skill variants. Update it deliberately after validation; do not track a moving branch.
...
```sh
queue_revision=dfcb59ccaea17d68fbd187f3ab19448e1feef894
